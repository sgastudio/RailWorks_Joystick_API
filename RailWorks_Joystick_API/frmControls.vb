...
Public Class frmControls
    ...
    Private Sub SetupAnalogControl(ByVal ControlName As String, ByVal Description As String)
        SetupMap(ControlName, Description)
        ControlManager.Show()
    End Sub
    Private Sub SetupButtonControl(ByVal ControlName As String, ByVal Description As String)
        SetupMap(ControlName, Description)
        ControlManager.Show()
    End Sub
